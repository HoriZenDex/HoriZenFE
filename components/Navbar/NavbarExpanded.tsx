    ...
    >
      <div className="w-full sticky top-0 z-10 bg-gradient-to-b from-black/60 to-black/40 backdrop-blur-sm py-4">
        <div className="flex justify-center space-x-4 w-full">
          <Button className="bg-[#03ceb3] hover:bg-[#08fcdb] text-gray-900 hover:text-black font-bold px-8 py-4 rounded-full transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:shadow-[#03ceb3]/50 relative overflow-hidden group">
