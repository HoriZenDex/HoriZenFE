            ...
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <div className="flex items-center">
                  <Image
                    src={creator?.avatar || `https://api.dicebear.com/6.x/initials/svg?seed=${nft.creator}`}
                    alt={nft.creator}
                    width={24}
                    height={24}
                  ...
                  />
                  <p
                    className="text-lg text-cosmic-cyan hover:text-cosmic-cyan/80 transition-colors duration-300 cursor-pointer"
                    onClick={() => router.push(`/creator/${creator?.id || nft.creator}`)}
                  >
                    by {nft.creator}
                  </p>
                </div>
